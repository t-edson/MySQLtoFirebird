...
procedure TFirebirdScript.writeScript(sqlOut: TStrings);
  ...
  var
    nullable, defaultStr, colType, autoincrem, dataTipeAd: String;
  begin
    ...
    if (UpCase(colType) = 'VARCHAR') and (col.VarCharSize > 32765) then begin
      colType := 'blob sub type 1';
      dataTipeAd := '';
    end;
    Result := col.name + ' ' + colType + dataTipeAd + autoincrem + defaultStr + nullable;
  end;
